...
import { Briefcase, Users, Stethoscope } from "lucide-react";
    ...
    return (
        <div className="p-4 sm:p-6 md:p-8">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">Gestiona usuarios, proveedores y la configuración de la plataforma.</p>
            </div>
